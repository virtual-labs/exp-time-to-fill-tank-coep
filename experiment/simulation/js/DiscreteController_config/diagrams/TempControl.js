...
//	paper = new Raphael(document.getElementById('canvas'), '100%', 700);
	...
	y = 300;
	 ...
	 paper.path('M'+(x+135)+' '+(y-35)+ 'l 0 -15 l 140 0').attr({'stroke':'black', 'stroke-width':'2', 'arrow-start':'classic-wide-long'});
	 ...
	 TCSuserDemandLbl =  paper.text((x+320), (y+250), "0 %").attr({	stroke : 'white','font-size' : 12,	"font-family": "sans-serif"	});
		
	 var CondensateOutlet = Label((x+300), (y+180), "Condensate Outlet");
	 var ColdWater = Label((x+310), (y-50), "Cold Water");
	 //TCSinletSourceLbl =  paper.text((x+320), (y+200), "0 %").attr({	stroke : 'white','font-size' : 12,	"font-family": "sans-serif"	});
