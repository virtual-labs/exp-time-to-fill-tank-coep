...
//	paper = new Raphael(document.getElementById('canvas'), '100%', 700);
	...
	waterlvlHT = waterlvlHT_FCS(0);
	waterlvl = drawWaterLvl_FCS(waterlvlHT);
	
	waterlvlper = Label1((x + 100), (y + 100), "0 %");
	...
	paper.path('M'+(x+95)+' '+(y-110)+ 'l 0 40').attr({'stroke':'black', 'stroke-width':'2	', 'arrow-end':'classic-wide-long'});	
	...
	Label((x+95), (y-125), "Inlet Source");
	inletSourceLbl =  paper.text((x+95), (y-150), "0 %").attr({	stroke : 'white','font-size' : 12,	"font-family": "sans-serif"	});
	Label((x+620), (y+257), "User Demand");
	userDemandLbl =  paper.text((x+620), (y+230), "0 %").attr({	stroke : 'white','font-size' : 12,	"font-family": "sans-serif"	});
	Label((x+510), (y+280), "FCV 100");
	
	paper.text((x+270), (y+380), "Flow Control System").attr({
			stroke : 'black',
			'font-size' : 25,
