...
Temp_config = function(appId){
		...
		var selectApp = '';
		selectApp +='<div id = "TCSConfigDiv" class="container-fluid">'
		    +'<div class="row">'
		    ...
		    +'<h1>Temperature Control System</h1>'
				...
				+'<select class="form-control" name="App" id="TCS_MinMaxLimit" >'
				...
				+'</select>'
				+'<button id="TCSConfigNext">Next</button>'
...
$("#TCSConfigNext").click(function(){
	...
	{ alert("Please select all the fields.");}
		...
		var minLimit = $("#TCS_MinMaxLimit").find(':selected').data('lowerspan');
		 var maxLimit =  $("#TCS_MinMaxLimit").find(':selected').data('higherspan');
